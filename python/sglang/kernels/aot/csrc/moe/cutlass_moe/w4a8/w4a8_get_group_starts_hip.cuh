...
#define __CALL_W4A8_GET_STARTS_KERNEL(TENSOR_C_TYPE, C_TYPE)                              \
   ...
   hipLaunchKernelGGL(( int4_fp8_get_group_gemm_starts<cutlass::float_e4m3_t, cutlass::int8_t, C_TYPE, float>) \
        , dim3(1), dim3(num_experts), 0, stream,                                                   \
...
#define __CALL_W4A8_GET_STARTS_KERNEL_3D(TENSOR_C_TYPE, C_TYPE)                              \
   ...
   hipLaunchKernelGGL(( int4_fp8_get_group_gemm_starts_3d<cutlass::float_e4m3_t, cutlass::int8_t, C_TYPE, float>) \
        , dim3(1), dim3(num_experts), 0, stream,                                                      \
            static_cast<cutlass::float_e4m3_t**>(a_ptrs.data_ptr()),                         \
            static_cast<cutlass::int8_t**>(b_ptrs.data_ptr()),                               \
            static_cast<C_TYPE**>(out_ptrs.data_ptr()),                                      \
