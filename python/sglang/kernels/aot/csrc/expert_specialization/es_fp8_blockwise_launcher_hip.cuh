...
#include "es_fp8_blockwise_functor_hip.cuh"
...
void es_sm90_fp8_blockwise_scaled_group_mm_pre_compute(
  ...
  if (!is_h20_device) {
   ...
   hipLaunchKernelGGL(( groupedGemmPreComputeKernel), dim3(1), dim3(num_experts), 0, stream, 
...
void es_sm90_fp8_blockwise_scaled_group_mm_distpatch_out_dtype(
    ...
    bool is_h20_device,
    hipStream_t stream,
    hipStream_t backup_stream_0,
    hipStream_t backup_stream_1) {
